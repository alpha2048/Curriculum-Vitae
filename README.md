...
- Kotlin
  - 経験：1年程度
  - フレームワーク → RxKotlin、Retrofit、Spek
- PHP
  - 経験：1年程度
  - フレームワーク → Larabel
- JavaScript
...
#### ートレンドの技術を使う  
AI・人工知能・ディープラーニングに興味があります。
それ以外にも、Web開発など、まだ自分が経験したことのない新しい技術に挑戦してみたいです。
...
サービスを成長へと導けるような、ビジネス知識なども兼ね備えたエンジニアになりたいです。  
そのため、幅広い技術知識の吸収はもちろん、サービスグロースの面においても力をつけたいと思っています。
...
- 成果がきちんと給料に反映される体系
  ...
  - お金は成長するためにも必要なので、ケチらずにしっかり出してほしい
- エンジニアがストレスなく開発できる環境
  - フレックス、リモートワーク制度を導入し、機能している

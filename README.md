...
- Kotlin
  - 経験：1年程度
  - フレームワーク → RxKotlin、Retrofit、Google各種ライブラリ、Glide、Spek、Mockito
- PHP
  - 経験：1年程度
  - フレームワーク → Larabel
- JavaScript
...
- エディタ
  ...
  - Xcode、Android Studio
    - どちらも手動リリース経験あり
    - CI/CDはある程度理解はしてますが構築はやったことないです
  - Visual Studio Code
    - 部分的な確認/改修で使う他、メモ帳やMarkdownエディタとして
- AWS
  - Lambda、EC2、S3などを趣味開発で使った経験あり
- コミュニケーションツール
  - Basecamp、Backlog、Slack、Miro、esa
- デザインツール (触ったことあり)
  - InVision、Abstract、Sketch、Zeplin

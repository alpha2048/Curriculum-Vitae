...
- Java
  - 経験：2年程度
  - 前職→開発委託しているアプリの部分機能開発、デバッグ、テストアプリ開発などを担当
  - 現職→機能実装、改修、テスト、リリースを担当。
  - フレームワークはRxJava、Retrofitをメインに使用
- Objective-C
  - 経験：2年程度
  - 前職→社内開発アプリの部分機能開発、デバッグ、テストアプリ開発も担当
  - フレームワークなどはほぼ使ったことありません。。
- Swift、Kotlin
  - 前職で簡単なテストアプリ開発で触ったことあり
- PHP
  - 経験：1年
  - 簡単なテストスクリプト作成を担当。フレームワークを使った開発などは未経験
- Python
  - 趣味ではメインで使ってます。半年程度
...
##### 業務内容
- Android版アプリの設計、開発、テスト。言語はJava
- アジャイルで新機能開発、既存機能の改修をほぼ一人で担当
- 場合によってはAPIやiOSのデバッグも担当
